...
(function ($) {
  ...
  THEME.Video = (function () {
    ...
    function keepScale(slider) {
      ...
      var wW = $(window).width();
      if (
        $bnsliderNoScale.hasClass("keep-scale") &&
        !$bnsliderNoScale.hasClass("bnslider--fullheight")
      ) {
        $bnsliderNoScale.css({
          height: "",
          "min-height": "",
        ...
        if (
          wW <= mobileBreikpoint &&
          parseInt($bnsliderNoScale.attr("data-start-mwidth")) > 0 &&
          parseInt($bnsliderNoScale.attr("data-start-mheight")) > 0
        ) {
          var bnrH =
            (parseInt($bnsliderNoScale.attr("data-start-mheight"), 10) /
              parseInt($bnsliderNoScale.attr("data-start-mwidth"), 10)) *
            wW;
          $bnsliderNoScale.css({
            height: bnrH + "px",
            "min-height": bnrH + "px",
          ...
          parseInt($bnsliderNoScale.attr("data-start-width")) > 0 &&
          parseInt($bnsliderNoScale.attr("data-start-height")) > 0
        ) {
          var bnrH =
            (parseInt($bnsliderNoScale.attr("data-start-height"), 10) /
              parseInt($bnsliderNoScale.attr("data-start-width"), 10)) *
            wW;
          if (
            $bnsliderNoScale.closest("div[class^='col-'],div[class*=' col-']")
              .length
          ) {
            var colW =
              ($bnsliderNoScale
                .closest("div[class^='col-'],div[class*=' col-']")
                .width() *
                100) /
              wW;
            bnrH = (bnrH * colW) / 100;
            ...
            var colW =
              ($bnsliderNoScale.closest(".container").width() * 100) / wW;
            bnrH = (bnrH * colW) / 100;
          }
          $bnsliderNoScale.css({
            height: bnrH + "px",
    ...
    function init($video) {
      ...
      $video
        .closest(selectors.videoWrapper)
        .find(".bnslider-text")
        .each(function () {
          var $this = $(this),
            thisInlineStyle = "";
          ...
          for (var data in thisStyle) {
            ...
            if (data == "fontline") {
              thisInlineStyle +=
                "line-height:" + $this.data("fontline") + "em;";
            }
            if (data == "fontweight") {
              thisInlineStyle +=
    ...
    function resizeVideo() {
      ...
      if (isMobile() && !iosMobileAutoplay) {
        ...
        for (key in videos) {
          if (
            videos[key].$videoWrapper.find("." + classes.videoWithImage).length
          ) {
            continue;
          }
  ...
  THEME.special = {
    ...
    collectionLoader: function collectionLoader() {
      $(document).on(
        "lazyloaded",
        ".has-infinite-scroll .js-circle-loader-ajax",
        function () {
    ...
    scrollNextSection: function scrollNextSection() {
      function goToByScroll($section) {
        var top = $section.offset().top,
          h = $(".hdr-content-sticky").length
            ? $(".hdr-content-sticky").height()
            : 0;
  ...
  THEME.initialization = {
    init: function init() {
      ...
      if ($(".bnslider .video").length)
        this.videoBannerInit(".bnslider .video");
      if ($(".mobilemenu-content").length)
        this.hideBeforeLoad(".mobilemenu-content", 1000);
      if ($(".js-filter-col").length)
        this.hideEmptyFilters(
          ".js-filter-col",
          ".sidebar-block_content",
          ".filter-toggle"
        );
      if ($(".js-filter-col-horizontal").length)
        this.hideEmptyFiltersH(
          ".js-filter-col-horizontal",
          ".sidebar-block_content",
          ".filter-toggle"
        );
      if ($(".product-tab").length) this.productTab(".product-tab");
      this.accordionSetActive();
      if ($(".collapsed-mobile").length)
        this.footerCollapse(".collapsed-mobile");
      if ($(".qty-input").length) this.qtyInput();
      if ($('[data-toggle="tooltip"]').length)
        this.tooltipIni(
          '[data-toggle="tooltip"]',
          '.prd-block [data-toggle="tooltip"]'
        );
      if ($(".js-countdown").length) this.countdown(".js-countdown");
      if ($(".js-newslettermodal").length)
      ...
      if ($(".bnslider--fullheight").length)
        this.setFullHeightSlider(".bnslider--fullheight");
      if ($("#productAccordion").length)
        this.openAccordion("#productAccordion");
      if ($(".js-simple-filter").length)
        this.simpleFilters(".js-simple-filter");
      ...
      if ($(".prd-block_accordion").length)
        this.tabScroll(".prd-block_accordion");
      if ($(".js-video-content").length) this.videoContent(".js-video-content");
      if ($("[data-toggle=popover]").length)
        this.popoverHtml("[data-toggle=popover]");
      ...
      var WishlistPage = {
        ...
        _handlers: function _handlers(that) {
          $(document).on("click", ".js-add-wishlist", function (e) {
            $(this)
              .closest(".prd, .prd-block_info")
              .addClass("prd--in-wishlist");
            e.preventDefault();
          });
    ...
    brandsColorHover: function brandsColorHover() {
      ...
      $grid
        .on("mouseenter", "a", function (e) {
          $(this)
            .closest(".js-color-hover-brand-grid")
            .find("img")
            .addClass("grayscale");
      ...
      $(popover).each(function () {
        ...
        if ($parent.length) {
          $(this).popover({
            ...
            template:
              '<div class="popover"><div class="arrow"></div><div class="popover-body"></div></div>',
          });
        }
      });
    },
    ...
    tabScroll: function tabScroll(accordion) {
      $(".collapse", $(accordion)).on("show.bs.collapse", function (e) {
        ...
        var top = $body.hasClass("has-hdr_sticky")
          ? $(".hdr").outerHeight()
          : 0;
        var bottomOffset =
          h - ($panel.offset().top - $window.scrollTop() + $(this).height());
        ...
        var MainSlider = {
          ...
          _animate: function _animate() {
            var that = this,
              ...
              animatedText =
                "[class^='bnslider-text'],[class*=' bnslider-text'],.btn-wrap",
                ...
                $textWrapper.find("span").each(function () {
                  ...
                  $this.html(
                    $this
                      ...
                      .replace(
                        /([^\x00-\x80]|\w)/g,
                        "<span class='letter' style='" + style + "'>$&</span>"
                      )
                  );
            ...
            function doAnimations(elements, first) {
              ...
              elements.each(function () {
                ...
                if (animationType == "fadeInDown") {
                  ...
                  var textWrapper = this.getElementsByClassName(
                  ...
                  anime.timeline({ loop: false }).add({
                    ...
                    delay: function delay(el, i) {
                      return (
                        animationDelay +
                        450 +
                        (el.parentNode.children.length - i - 1) * 30
                      );
                    },
                  });
                  anime
            ...
            $slider.on("init", function (slick) {
              ...
              if (isMobile) {
                if (
                  !$(".bnslider-image-mobile", $currentSlide).find("img").length
                ) {
                  startInit($firstAnimatingElements);
                } else {
                  $(".bnslider-image-mobile", $currentSlide).one(
                    "lazyloaded",
                    function () {
                      startInit($firstAnimatingElements);
                    }
                ...
                if (!$(".bnslider-image", $currentSlide).find("img").length) {
                  ...
                  $(".bnslider-image", $currentSlide).one(
                    "lazyloaded",
                    function () {
                      startInit($firstAnimatingElements);
                    }
              ...
              var status =
                $currentSlide.data("autoplay") == true ? "play" : "pause";
            ...
            $slider.on("afterChange", function (e, slick) {
              ...
              var $currentSlide = slick.find(".slick-current"),
                status =
                  ($currentSlide.data("autoplay") == true &&
                    !$currentSlide.hasClass("is-custom-paused")) ||
                  $currentSlide.hasClass("is-custom-playing")
                    ? "play"
                    : "pause",
            ...
            $slider.on(
              ...
              function (event, slick, currentSlide, nextSlide) {
                ...
                var $nextSlide = $slider.find(
                    '.bnslider-slide[data-slick-index="' + nextSlide + '"]'
                  ),
              ...
              if (slideType === "youtube") {
                switch (control) {
                  case "play":
                    ...
                    if (userConrol)
                      currentSlide
                        .addClass("is-custom-playing")
                        .removeClass("is-custom-paused");
                    break;
                  case "pause":
                    playerSend(player, {
                      event: "command",
                    ...
                    if (userConrol)
                      currentSlide
                        .removeClass("is-custom-playing")
                        .addClass("is-custom-paused");
                    break;
                }
              ...
              if (
                ...
                if (
                  ...
                  var bnrH =
                    (parseInt($bnsliderNoScale.attr("data-start-mheight"), 10) /
                      parseInt(
                        $bnsliderNoScale.attr("data-start-mwidth"),
                        10
                      )) *
                    wW;
                  $bnsliderNoScale.css({
                  ...
                  if (
                    ...
                    var colW =
                      ($bnsliderNoScale.closest(".container").width() * 100) /
                      wW;
                    bnrH = (bnrH * colW) / 100;
                  }
                  $bnsliderNoScale.css({
      ...
      if (!$body.hasClass("touch")) {
        $document
          .on("mouseenter", "[data-hover-bgcolor]", function (e) {
            var $this = $(e.target),
              color = $this.attr("data-hover-bgcolor")
                ? $this.attr("data-hover-bgcolor")
                : "";
            $this.css({
        ...
        THEME.simplefilters = {
          ...
          _clickFirst: function _clickFirst($gallery) {
            if ($(".faq-item", $gallery).length) {
              $(".panel-heading.active", $gallery)
                .find(".panel-title")
                .trigger("click");
              $(".faq-item.isvisible", $gallery)
                .first()
                .find(".panel-title")
                .trigger("click");
            }
          ...
          init: function init(options) {
            ...
            $(that.default.holder).each(function () {
              var $this = $(this),
                wh = $window.height();
              if (
                $(that.default.header).length &&
                $(that.default.footer).length
              ) {
                $this.css({
                  "min-height":
                    wh -
                    $(that.default.header).outerHeight() -
                    $(that.default.footer).outerHeight() -
                    parseInt($(that.default.footer).css("marginTop")) +
                    "px",
                });
              } else if ($(that.default.header).length) {
                $this.css({
                  "min-height":
                    wh - $(that.default.header).outerHeight() + "px",
                });
    ...
    backToTop: function backToTop(button) {
      function scrollToTop() {
        ...
        var speed =
          $window.scrollTop() / 5 > 500 ? $window.scrollTop() / 5 : 500;
        if (isMobile) {
          speed = speed / 2;
        }
        $("html, body").animate(
        ...
        $body.hasClass("has-hdr_sticky")
          ? THEME.stickyheader.destroySticky()
          : false;
      }
    ...
    promoPopup: function promoPopup(modal) {
                  ...
                  n(function i() {
                    u || d || (c(o), (u = o.width), (d = o.height)),
                      ...
                      (a = a.filter(function (t) {
                        ...
                        ? n(i)
                        : (t.removeEventListener("resize", m), l(), e());
                  });
                }),
          ...
          (e.exports = function (t) {
            for (
              var e,
                n,
                i,
                r = l(t, "particleCount", Math.floor),
                a = l(t, "angle", Number),
                d = l(t, "spread", Number),
                m = l(t, "startVelocity", Number),
                f = l(t, "decay", Number),
                h = l(t, "colors"),
                b = l(t, "ticks", Number),
                y = l(t, "zIndex", Number),
                g =
                  (((e = l(t, "origin", Object)).x = l(e, "x", Number)),
                  (e.y = l(e, "y", Number)),
                  e),
                M = r,
                p = [],
      ...
      function checkCookie() {
        if (
          ...
          $promoPopup.attr("data-expires") == "0" ||
          $("body").hasClass("demo")
        ) {
          openPromoPopup();
        }
      ...
      function openPromoPopup() {
        var pause =
            $promoPopup.attr("data-pause") > 0
              ? $promoPopup.attr("data-pause")
              : 2000,
            ...
            [
              {
                ...
                btnTpl: {
                  smallBtn:
                    '<div data-fancybox-close class="fancybox-close-small js-popup-promo-close"><i class="icon-close"></i></div>',
                },
                baseTpl:
    ...
    newsletterModal: function newsletterModal(modal, checkbox) {
      ...
      var $newsletter = $(modal),
        $checkBox = $(checkbox);
      if (
        $newsletter.attr("data-only-index") == "true" &&
        !$('body[class*="page-index"]').length
      ) {
        return false;
      }
      ...
      function checkCookie() {
        if (
          $.cookie("foxicNewsLetter") != "yes" ||
          $newsletter.attr("data-expires") == "0" ||
          $("body").hasClass("demo")
        ) {
          openNewsletterPopup();
        }
      ...
      function openNewsletterPopup() {
        var pause =
          $newsletter.attr("data-pause") > 0
            ? $newsletter.attr("data-pause")
            : 2000;
        setTimeout(function () {
          if ($newsletter.hasClass("modal-info-content")) {
            ...
            anime({
              ...
              duration: 300,
              complete: function complete() {
                if ($newsletter.find("svg").length)
                  THEME.initialization.resizeSvgRect();
              },
            });
          }
        }, pause);
    ...
    hideEmptyFilters: function hideEmptyFilters(
      columnFilter,
      filter,
      mobFilter
    ) {
    ...
    hideEmptyFiltersH: function hideEmptyFiltersH(
      columnFilter,
      filter,
      mobFilter
    ) {
          ...
          if (!isMobile && !$(".aside").length) {
            if ($(".hdr-transparent").length) {
              ...
              $(this.default.text).css({
                "padding-top": $(this.default.header).outerHeight() * 0.85,
              });
            }
          } else {
            $(this.default.text).css({
    ...
    countdown: function countdown(_countdown) {
      ...
      $(_countdown).each(function () {
        ...
        if (isActual) {
          $countdown
            .countdown(promoperiod, function (event) {
              $countdown.html(
                event.strftime(
                  "<span><span>%D</span>" +
                    timeLocale[0] +
      ...
      THEME.flowtype = {
        ...
        init: function init(bnr) {
          ...
          $(bnr).each(function () {
            ...
            $this.imagesLoaded(function () {
              var fontratio =
                Math.round($this.attr("data-fontratio") * 100) / 100;
              if (fontratio > 0) {
        ...
        _changes: function _changes(el, fontRatio) {
          var $el = $(el),
            elw = $el.width(),
            width =
              elw > this.default.maximum
                ? this.default.maximum
                : elw < this.default.minimum
                ? this.default.minimum
                : elw,
            fontBase = width / fontRatio,
            fontSize =
              fontBase > this.default.maxFont
                ? this.default.maxFont
                : fontBase < this.default.minFont
                ? this.default.minFont
                : fontBase;
          setTimeout(function () {
          ...
          setTimeout(function () {
            $topline.slideDown(speed, function () {
              ...
              if ($body.hasClass("has-hdr_sticky"))
                THEME.stickyheader.setHeaderHeight();
            });
          }, timeout);
        } else {
          $topline.slideUp(0);
      ...
      THEME.megamenu = {
        ...
        _handlers: function _handlers(menu) {
          function setMaxHeight(wHeight, submenu) {
            ...
            if (submenu.length) {
              var maxH = $body.hasClass("has-sticky")
                ? wHeight - $(".hdr-content-sticky").outerHeight()
                : wHeight -
                  submenu.prev().offset().top -
                  submenu.prev().outerHeight();
          ...
          var $menu = $(menu.defaults.menu),
            ...
            $headerCartToggleBtn = $headerCart.find(
              menu.defaults.headerCartToggleBtn
            ),
            $headerCartDropdn = $headerCart.find(
              menu.defaults.headerCartDropdn
            ),
          ...
          $menu
            .on(
              "mouseenter.mmenu",
              megaDropdnClass + "> a," + simpleDropdnClass + "> a",
              function () {
                var $this = $(this);
            ...
            .on(
              "mouseleave.mmenu",
              megaDropdnClass + "," + simpleDropdnClass,
              function () {
                var $this = $(this);
                clearTimeout(timer);
                clearMaxHeight();
          ...
          $("li", $submenu)
            .on("mouseenter", function () {
              ...
              if ($("> .submenu-link-image", $this).length) {
                var $elm = $("> .submenu-link-image", $this),
                  isXvisible = $body.hasClass("rtl")
                    ? $elm.offset().left >= 0
                    : $elm.offset().left + $elm.width() <= w,
                  isYvisible =
                    h +
                    $window.scrollTop() -
                ...
                var _$elm = $(".mmenu-submenu", $this).length
                    ? $(".mmenu-submenu", $this)
                    : $("ul:first", $this),
                  _isXvisible = 0,
                  _isYvisible = 0;
                if (
                  $this.closest(".mmenu-item--mega").length &&
                  $this.parent().hasClass("submenu-list")
                ) {
                  if (!$body.hasClass("rtl")) {
                    _$elm.css({
                      top:
                        $this.offset().top -
                        $this.closest(".mmenu-submenu").offset().top,
                ...
                _isXvisible = $body.hasClass("rtl")
                  ? _$elm.offset().left >= 0
                  : _$elm.offset().left + _$elm.width() <= w;
                _isYvisible =
                  h +
                  $window.scrollTop() -
                  (_$elm.offset().top + _$elm.outerHeight());
                if (!_isXvisible) {
            ...
            .on("mouseleave", function () {
              var $elm = $(".mmenu-submenu", this).length
                ? $(".mmenu-submenu", this)
                : $("ul:first", this);
              var $this = $(this)
    ...
    mmobilePush: function mmobilePush() {
      THEME.mobilemenupush = {
        ...
        _setHeigth: function _setHeigth() {
          $(".nav-wrapper").css({
            height: $(
              "mmenu-submenu-active .nav-level-" + (this.defaults.curLevel + 1)
            ).outerHeight(),
          });
        },
        ...
        _updateActiveMenu: function _updateActiveMenu(direction) {
          ...
          if (direction === "back") {
            ...
            that.defaults.curItem = that.defaults.curItem
              .parent()
              .closest("li");
            curItem.addClass("mmenu-submenu-open mmenu-submenu-active");
            that._updateMenuTitle();
          } else {
            that.defaults.curItem.addClass(
              "mmenu-submenu-open mmenu-submenu-active"
            );
            that._updateMenuTitle();
          }
        },
        _updateMenuTitle: function _updateMenuTitle() {
          ...
          if (that.defaults.curLevel > 0) {
            ...
            link = that.defaults.curItem.children("a").attr("href")
              ? that.defaults.curItem.children("a").attr("href")
              : "";
        ...
        _slideMenu: function _slideMenu(direction) {
          var that = this,
            $mmenu = $(that.defaults.initElem);
          if (direction === "back") {
            that.defaults.curLevel =
              that.defaults.curLevel > 0 ? that.defaults.curLevel - 1 : 0;
            setTimeout(function () {
              that._updateHeight();
            }, 300);
          } else {
    ...
    headerDrop: function headerDrop() {
      THEME.headerdrop = {
          ...
          if (isMobile) {
            if (!$dropLink.data("mclick")) {
              ...
              $dropLink.on("click.dropdn", function (e) {
                bodyScrollLock.disableBodyScroll($scroll);
                var $this = $(this),
                  $panel = $($this.data("panel")).length
                    ? $($this.data("panel"))
                    : $this.next();
                if ($this.closest(".js-popupAddToCart").length) {
                  THEME.selectModal &&
                    THEME.selectModal.ifOpened() &&
                    THEME.selectModal.close();
                  THEME.checkOutModal &&
                    THEME.checkOutModal.ifOpened() &&
              ...
              $dropLinkParent.on("click.dropdn", function (e) {
                var $this = $(e.target);
                if (
                  !$this.closest(".dropdn-content").length &&
                  $(".header-side-panel").find(".is-opened").length &&
                  !$this.closest(".mobilemenu").length
                ) {
            ...
            if (!$dropLink.data("click")) {
              ...
              $document.on("click.dropdn", function (e) {
                ...
                if (!$this.closest(".dropdn-content").length) {
                  if ($popupCheckCart.hasClass("is-hovered"))
                    $popupCheckCart.removeClass("is-hovered");
                  if ($(".header-side-panel").find(".is-opened").length) {
                    $dropLinkParent.removeClass("is-hovered");
                    $(".header-side-panel")
                      .find(".is-opened")
        ...
        _getDropHeight: function _getDropHeight(dropdn) {
          ...
          if (
            $parent.length &&
            dropdn.closest(".dropdn_fullheight,.dropdn_fullwidth").length
          ) {
          ...
          if ($parent.length) {
            if (dropdn.closest(".dropdn_fullheight").length) {
              ...
              if (dropdn.closest(".hdr-content-sticky").length) {
                ...
                $header.hasClass("hdr-style4") ||
                $header.hasClass("hdr-style7")
              ) {
        ...
        THEME.stickyheader = {
          ...
          init: function init(options) {
            ...
            if ($(this.defaults.stickyNav).length) {
              $(this.defaults.hdrNav)
                .children()
                .clone(true)
                .appendTo(this.defaults.stickyNav);
            }
            if (!isMobile) {
              this._multirow();
              this._multirowS();
          ...
          _multirowS: function _multirowS() {
            if ($body.hasClass("has-hdr_sticky")) {
              if ($(this.defaults.stickyNav).height() > 60) {
                ...
                $(this.defaults.headerSticky).removeClass("mmenu-multirow-s");
            }
          },
          ...
          _setScroll: function _setScroll() {
            var that = this,
              offset =
                that.defaults.offset +
                $(that.defaults.headerSticky).outerHeight(),
              checkColission =
                !isMobile || $(that.defaults.stickyCollision).length
                  ? true
                  : false;
    ...
    quickView: function quickView() {
      THEME.quickView = {
          ...
          $document.on("click", ".js-prd-quickview", function (e) {
            ...
            $.fancybox.open({
              ...
              afterShow: function afterShow() {
                ...
                THEME.product.swatchToggle(
                  "#modalQuickView .prd-color.swatches"
                );
                setTimeout(function () {
                ...
                THEME.initialization.tooltipIni(
                  $('#modalQuickView [data-toggle="tooltip"]')
                );
                that._setScroll();
              ...
              afterClose: function afterClose() {
                ...
                THEME.productpagegallery
                  ? THEME.productpagegallery.reinitZoom()
                  : false;
        ...
        ifOpened: function ifOpened() {
          if (
            $("#modalQuickView").length &&
            $("#modalQuickView").closest(".fancybox-is-open").length
          ) {
            return true;
          } else {
            return false;
        ...
        _setScroll: function _setScroll() {
          if (w > maxMD) {
            if ($(".modal-quickview--classic").length) {
              ...
              $("#modalQuickView .quickview-info").css({
                "min-height": h,
                height: h,
              });
            } else {
              $("#modalQuickView .quickview-info").css({
                height: $(".modal--quickview").height(),
              });
            }
            $("#modalQuickView .quickview-info").perfectScrollbar();
          } else {
            $("#modalQuickView .prd-block").css({
              height: $(".modal--quickview").height(),
            });
    ...
    checkOut: function checkOut() {
      THEME.checkOutModal = {
        defaults: {
          ...
          image:
            ".popup-addedtocart_image > img, .popup-addedtocart_image > span > img",
        ...
        var SelectModal = {
            ...
            if (data) {
              ...
              if ($(that.defaults.imageZoom).length) {
                if (data.path_image_big.indexOf("no-image") == -1) {
                  $(that.defaults.imageZoom, $popup).attr(
                    "href",
                    data.path_image_big
                  );
                } else {
              ...
              $(that.defaults.priceActual, $popup)
                .empty()
                .html(data.price_actual);
              if (
                data.price_old &&
                parseInt(data.price_old.replace(/[^0-9]/g, "")) >
                  parseInt(data.price_actual.replace(/[^0-9]/g, ""))
              ) {
          ...
          setData: function setData(data) {
            ...
            $.each(data.variants, function (key, value) {
              ...
              $(that.defaults.options, $popup).append(
                $("<option " + option_status + ">", { value: value.id }).text(
                  key + value.info
                )
              );
              $(that.defaults.options, $popup)
                .find("option")
                .last()
                .data("variant", value);
            });
                ...
                ],
                {
                  ...
                  afterClose: function afterClose() {
                    if (!$popup.data("secondClick")) {
                      $body.removeClass(
                        "fancybox--under-modals fancybox--from-sticky"
                      );
                    } else {
          ...
          show: function show() {
            var that = this,
              $popup = $(that.defaults.popup),
              popupAlt = $(that.defaults.popupAlt),
              hPopup = $popup.data("height")
                ? $popup.data("height")
                : $popup.find(".container").outerHeight(),
              duration = 200,
              h = 0;
            if (that.defaults.sticky && $popup.hasClass("closed")) {
              return false;
  ...
  THEME.product = {
      ...
      $(option).each(function () {
        ...
        $optionbtn.on("click touchstart", function (e) {
          ...
          if (!$optionlist.hasClass("js-list-filter")) {
            ...
            $carousel.slick(
              "slickFilter",
              'div[data-value="' + currentSelect + '"]'
            );
            $previewsCarousel.slick(
              "slickFilter",
              'a[data-value="' + currentSelect + '"]'
            );
            $carousel.slick("refresh");
            $previewsCarousel.slick("refresh");
            if (
              $previewsCarousel.find(".slick-arrow:not(.slick-disabled)").length
            ) {
          ...
          if (!$this.parent("li").is(".active")) {
            ...
            var text = $this.attr("data-original-title")
              ...
              : currentSelect;
            $this
              .closest(".prd-block_options")
              .find(".prd-block_options_selected")
              .html(text);
          }
          e.preventDefault();
        });
    ...
    colorToggle: function colorToggle() {
      THEME.colortoggle = {
        ...
        _handlers: function _handlers() {
          var that = this;
          $document
            .on("click", that.defaults.toggle, function (e) {
              e.preventDefault();
            })
              ...
              if ($el.data("image")) {
                ...
                if ($el.data("aspect") && !$prd.data("firstAspect")) {
                  $prd.data(
                    "globalAspect",
                    $el
                      .closest(that.defaults.colorswatch)
                      .find("li")
                      .first()
                      .data("aspect")
                  );
      ...
      var ProductPageGallery = {
        ...
        _zoomLinkEvent: function _zoomLinkEvent() {
          var that = this,
            ...
            $carousel = $(that.defaults.carousel);
          if (
            $zoomLink.closest(".prd-block").find(".product-previews-carousel")
              .length
          ) {
        ...
        destroy: function destroy() {
          var that = this,
            $carousel = $(that.defaults.carousel),
            $previews = that.defaults.quickView
              ? $(that.defaults.previews)
              : $carousel.closest(".prd-block").find(that.defaults.previews);
          if ($previews.length) {
        ...
        _handlers: function _handlers() {
          var that = this,
            ...
            $previews = that.defaults.quickView
              ? $(that.defaults.previews)
              : $carousel.closest(".prd-block").find(that.defaults.previews),
            zoomPosition = $mainMedia.data("zoom-position")
              ? $mainMedia.data("zoom-position")
              : false,
            fade = false,
            asNavForCarousel = false,
            asNavForPreview = false,
            rows = $previews.closest(that.defaults.doubleSelector).length
              ? 2
              : 1,
            slidesToShow =
              $previews.closest(that.defaults.doubleSelector).length &&
              $previews.closest(that.defaults.verticalSelector).length
                ? 3
                : $previews.closest(that.defaults.verticalSelector).length
                ? 6
                : 4,
            slidesToShowT = $previews.closest(that.defaults.doubleSelector)
              .length
              ? slidesToShow
              : $previews.closest(that.defaults.verticalSelector).length
              ? slidesToShow - 1
          ...
          if ($previews.length) {
            startSlide = $previews.find(".active").length
              ? $previews.find(".active").index()
              : 0;
            if ($previews.closest(that.defaults.doubleSelector).length) {
          ...
          if ($carousel.length) {
            ...
            $carousel.on("afterChange", function (event, slick, currentSlide) {
              ...
              if (slick.closest(that.defaults.doubleSelector).length) {
                var previewsRow =
                    currentSlide < 2 ? 0 : Math.floor(currentSlide / 2),
          ...
          if ($previews.length) {
            ...
            if (that.defaults.quickView) {
              var vertical = $(".modal-quickview--classic").length
                ? false
                : true;
              $previews.slick({
                slidesToShow: 4,
              ...
              $previews.slick({
                ...
                slidesToScroll: 1,
                dots: false,
                vertical: $previews.closest(that.defaults.verticalSelector)
                  .length
                  ? true
                  : false,
                swipe: swipemode,
                ...
                responsive: [
                  {
                    breakpoint: 1400,
                    settings: {
                      vertical: $previews.closest(
                        that.defaults.verticalSelector
                      ).length
                        ? true
                        : false,
            ...
            $document.on("click", that.defaults.previews + " a", function (e) {
              ...
              if ($this.hasClass("active")) {
                ...
                if ($this.closest(that.defaults.doubleSelector).length) {
                  ...
                  $carousel.slick(
                    "slickGoTo",
                    $this.closest(".slick-slide").data("slick-index") * 2 +
                      $this.parent().index(),
                    false
                  );
    ...
    productHoverHeight: function productHoverHeight(product) {
      ...
      $document
        .on("mouseenter", product, function (e) {
          ...
          if (
            $this.closest(".single-prd-carousel").length ||
            $this.closest(".prd-listview").length
          )
            return false;
    ...
    actionPrd: function actionPrd() {
      THEME.productAction = {
        ...
        numberLine: function numberLine() {
          var that = this;
          $(that.defaults.minicart)
            .find(that.defaults.minicartProduct)
            .each(function (i) {
              $(this)
                .find("[data-line-number]")
                .attr("data-line-number", i + 1);
            });
        },
    ...
    productWidth: function productWidth(product) {
      ...
      $(product).each(function () {
        var $this = $(this);
        $this.removeClass(
          "prd-w-xl prd-w-lg prd-w-md prd-w-sm prd-w-xs prd-w-xxs"
        );
  ...
  THEME.productPage = {
    init: function init() {
      this.simpleFancyGallery(
        '.prd-block [data-fancybox="galleryQW"], .prd-block [data-fancybox="gallery"]'
      );
      this.shiftTitle();
    ...
    countdownCircle: function countdownCircle() {
      ...
      var closesTime = closestTime(array, dt),
        timeBreikpoint =
          closesTime.getHours() +
          ":" +
          closesTime.getMinutes() +
          ":" +
          closesTime.getSeconds(),
        leftTime = Math.abs(closesTime - dt) / 1000,
        format =
          "<span><span>%H</span>:</span><span><span>%M</span>:</span><span><span>%S</span></span>";
      $countdownCircleTimer
        .countdown(date + " " + timeBreikpoint, function (event) {
        ...
        .on("finish.countdown", function () {
          ...
          timeBreikpoint =
            ...
            closesTime.getSeconds();
          leftTime = Math.abs(closesTime - dt) / 1000;
          $countdownCircleTimer.countdown(
            date + " " + timeBreikpoint,
            function (event) {
              $countdownCircleTimer.html(event.strftime(format));
            }
      ...
      $shippingDate.html(
        ("0" + (Math.floor(leftTime / 3600) % 24)).slice(-2) +
          ":" +
          ("0" + (Math.floor(leftTime / 60) % 60)).slice(-2) +
          ":" +
          ("0" + Math.floor(leftTime % 60)).slice(-2)
      );
      var deliveryDate = new Date();
      deliveryDate.setDate(dt.getDate() + 3);
      $deliveryDate.html(
        getDayOfWeek(deliveryDate, $deliveryDate.data("weekday")) +
          " " +
    ...
    progressBar: function progressBar() {
      THEME.progressbar = {
        ...
        init: function init(options) {
          ...
          that.data.stockLeft = Math.floor(
            Math.random() *
              (that.data.stockLeftMax - that.data.stockLeftMin + 1) +
              that.data.stockLeftMin
          );
          ...
          var timerStart = setInterval(function () {
            ...
            that._stockDown(
              that.data.downInterval,
              that.data.stockLeft - 1,
              that.data.stockMin
            );
      ...
      THEME.stickyaddtocart = {
        ...
        init: function init(options) {
          ...
          if ($stickyAddToCart.length && $button.length) {
            $window.on(
              "load.stickyAddToCart scroll.stickyAddToCart",
              function () {
    ...
    shiftTitle: function shiftTitle() {
      if (
        $(".prd-block-under").length &&
        $(".product-previews-wrapper").length
      ) {
    ...
    productTitleReposition: function productTitleReposition() {
      THEME.prdrepos = {
        init: function init(options) {
          ...
          if (
            $(this.default.mobile).closest(".prd-block--mobile-image-first")
              .length
          )
            return false;
      ...
      $document.on("click", link, function (e) {
        ...
        if ($panReview.length) {
          if ($panReview.closest(tabPaneM).length) {
            var $reviewTab = $panReview
              .closest(tabPaneM)
              .find(".panel-title > a");
            if (!$reviewTab.closest(".panel-heading").hasClass("active"))
    ...
    paymentNotification: function paymentNotification(options) {
      THEME.paymentnotification = {
        ...
        init: function init(options) {
          ...
          that.defaults.fromArray = $paymentNotification
            .parent()
            .data("from")
            .split(",");
          that.defaults.productArray = $paymentNotification
            .parent()
            .data("products");
          that.defaults.paymentNotificationVisible = $paymentNotification.data(
            "visible-time"
          )
            ? $paymentNotification.data("visible-time")
            : 10000; // min 2000
          that.defaults.paymentNotificationHidden = $paymentNotification.data(
            "hidden-time"
          )
            ? $paymentNotification.data("hidden-time")
            : 10000; // min 2000
          that.defaults.paymentNotificationDelay = $paymentNotification.data(
            "delay"
          )
            ? $paymentNotification.data("delay")
            : 5000;
          var delay =
            that.defaults.paymentNotificationDelay >
            that.defaults.paymentNotificationHidden
              ? that.defaults.paymentNotificationDelay -
                that.defaults.paymentNotificationHidden
              : that.defaults.paymentNotificationHidden;
          setTimeout(function () {
            that._showPaymentNotification(
              Math.floor(Math.random() * that.defaults.productArray.length)
            );
          }, delay);
        ...
        _setData: function _setData(i) {
          ...
          $(".js-pn-link").attr(
            "href",
            that.defaults.productArray[i].productlink
          );
          $(".js-pn-link").attr(
            "title",
            that.defaults.productArray[i].productname
          );
          $(".js-pn-link-quickview").data(
            "src",
            that.defaults.productArray[i].productlink +
              "?view=quick-view&output=embed"
          );
          $(".js-pn-image").attr(
            "src",
            that.defaults.productArray[i].productimage
          );
          $(".js-pn-from").html(
            that.defaults.fromArray[random(0, that.defaults.fromArray.length)]
          );
          $(".js-pn-time").html(
            random(that.defaults.minAgoMin, that.defaults.maxAgoMin)
          );
        },
      ...
      if (
        $.cookie("foxicPromoProduct") != "yes" ||
        $(".payment-notification").attr("data-expires") == "0" ||
        $("body").hasClass("demo")
      ) {
  ...
  THEME.catalog = {
    ...
    loadMoreAjax: function loadMoreAjax(button) {
      function updateCircleLoader($button) {
        var start = ($button.data("loaded") * 100) / $button.data("total"),
          to =
            (($button.data("loaded") + $button.data("load")) * 100) /
            $button.data("total");
      ...
      $(button).on("click", function (e) {
        ...
        $.getJSON($this.attr("href"), function (data) {
          var html = "",
            ...
            max =
              Math.min(
                parseInt($this.data("total"), 10),
                $this.data("load") + $this.data("loaded")
              ) - 1,
    ...
    postAjaxCatalog: function postAjaxCatalog() {
      THEME.flowtype
        ? THEME.flowtype.hideCaption(".bnr[data-fontratio]")
        : false;
      ...
      setTimeout(function () {
        THEME.flowtype
          ? THEME.flowtype.showCaption(".bnr[data-fontratio]")
          : false;
    ...
    blockCollapse: function blockCollapse(el) {
      ...
      $(".sidebar-block_title", collapsed).on(
        "click.blockCollapse",
        function (e) {
          e.preventDefault;
          var $this = $(this),
      ...
      if ($(el).length) {
        THEME.mobileFilter = {
          ...
          setShift: function setShift(delay) {
            var that = this,
              left = $(that.options.mobileFilter).hasClass("filter-col--opened")
                ? $(that.options.mobileFilter).offset().left
                : $(that.options.grid).offset().left;
            ...
            if (isMobile) {
              ...
              $(".footer-sticky").css({
                bottom: $(".js-filter-toggle").outerHeight(),
              });
            } else {
              if ($("body").hasClass("rtl")) {
                $(".js-filter-toggle").css({
          ...
          _handlers: function _handlers() {
            ...
            $document.on("click", toggleButton, function (e) {
              ...
              if ($mobileFilter.hasClass("filter-col--opened")) {
                var _h3 = $mobileFilter
                  .find(".filter-row-content")
                  .outerHeight();
        ...
        _handlers: function _handlers() {
          $horGrid.on("click", function (e) {
            ...
            if (!$this.is(".active")) {
              ...
              $('.list-options [data-toggle="tooltip"]', $products)
                .attr("data-placement", "right")
                .tooltip("dispose");
              $('.prd-circle-labels [data-toggle="tooltip"]', $products)
                .attr("data-placement", "left")
                .tooltip("dispose");
              THEME.initialization.tooltipIni(
                $('[data-toggle="tooltip"]', $products)
              );
              THEME.product.productWidth(".prd, .prd-hor, .prd-promo");
              setTimeout(function () {
  ...
  THEME.forms = {
    ...
    checkoutDisable: function checkoutDisable() {
      $(document).on("change", "[data-checkbox-btn]", function (e) {
        var $this = $(e.target);
        $this.is(":checked")
          ? $($this.attr("data-checkbox-btn")).removeClass("btn-disable")
  ...
  THEME.sections = {
    init: function init() {
      ...
      if ($(".js-gallery-isotope").length)
        this.galleryIsotope(".js-gallery-isotope");
      if ($(".js-product-isotope").length)
        this.productIsotope(".js-product-isotope");
      if ($(".js-product-isotope-sm").length)
        this.productIsotopeSm(".js-product-isotope-sm");
    ...
    productTabs: function productTabs() {
      $(".js-circle-loader").on("click", function (e) {
        ...
        $.getJSON($this.attr("href"), function (data) {
          ...
          var start = ($this.data("loaded") * 100) / $this.data("total"),
            to =
              (($this.data("loaded") + $this.data("load")) * 100) /
              $this.data("total");
      ...
      $("[data-grid-tab-title]").on("click", function (e) {
        ...
        var $loader = $this.closest(".holder").find(".js-circle-loader"),
          ...
          to =
            (($this.data("loaded") + $(".js-circle-loader").data("load")) *
              100) /
            $this.data("total");
    ...
    arrowCenter: function arrowCenter(carousel, arrow, image, delay) {
      ...
      image = $carousel.attr("data-center")
        ? $carousel.attr("data-center")
        : image;
    ...
    creativeSlider: function creativeSlider(el) {
      ...
      $slider.on("init", function (slick) {
        ...
        setTimeout(function () {
          ...
          doAnimations(
            $currentSlide.find(".col:not(.prd-single-col)"),
            "fadeInRight",
            1000
          );
          doAnimations(
            $currentSlide.find(".js-creative-image"),
            "driveInLeft",
            1000
          );
          ...
          doAnimations(
            $currentSlide.find(
              ".creative-product-carousel-text:not(.creative-prd-single-text)"
            ),
            "fadeInRightBig",
            800
          );
          doAnimations(
            $currentSlide.find(".creative-prd-single-text"),
            "fadeIn",
            800
          );
        }, 100);
      ...
      $slider.on("afterChange", function (e, slick) {
        ...
        slick
          .next(tabs)
          .find(".js-collection-grid-nav:nth-child(" + index + ")")
          .addClass("active");
        setTimeout(function () {
          slick
            .next(tabs)
    ...
    slickCarousels: function slickCarousels() {
      if ($(".data-slick").length) {
        $(".data-slick").each(function () {
          var $this = $(this),
            arrowsplace = $this.parent().find(".carousel-arrows").length
              ? $this.parent().find(".carousel-arrows")
              : $this;
            ...
            if ($this.hasClass("collection-carousel-2")) {
              if ($this.find(".lazyload").length) {
                $this
                  ...
                  .first()
                  .on("lazyloaded", function () {
                    THEME.sections.arrowCenter(
                      $this,
                      ".slick-arrow",
                      ".collection-carousel-2-img > img",
                      10
                    );
                  });
              } else
      ...
      if ($(".js-post-prws-carousel").length) {
        $(".js-post-prws-carousel").each(function () {
          ...
          $this.on("init", function () {
            if ($(".js-post-prw-adaptive").length)
              THEME.sections.postWidth(".js-post-prw-adaptive");
          });
          $this.slick({
            arrows: true,
            dots: false,
      ...
      if ($(".js-brand-carousel").length) {
        $(".js-brand-carousel").each(function () {
          var $this = $(this);
          if ($this.hasClass("slick-initialized")) return false;
          var arrowsplace = $this.parent().find(".carousel-arrows").length
              ? $this.parent().find(".carousel-arrows")
              : $this,
            slidesToShow_lg = 5,
            slidesToScroll_lg = 1,
      ...
      if ($(".js-prd-carousel-vert-2").length) {
        $(".js-prd-carousel-vert-2").each(function () {
          var $this = $(this);
          if ($this.hasClass("slick-initialized")) return false;
          var arrowsplace = $this
            .parent()
            .parent()
            .find(".js-prd-carousel-vert-arrows").length
            ? $this.parent().parent().find(".js-prd-carousel-vert-arrows")
            : $this.parent().find(".js-prd-carousel-vert-arrows").length
            ? $this.parent().find(".js-prd-carousel-vert-arrows")
            : $this;
          $this.slick({
            slidesToShow: 2,
            slidesToScroll: 1,
    ...
    prdCarousel: function prdCarousel() {
      THEME.prdcarousel = {
        ...
        init: function init(options) {
          ...
          if (
            w < maxSM &&
            $(this.defaults.carousel).hasClass("js-product-grid-sm")
          ) {
            return false;
          }
          this.reinit();
        ...
        reinit: function reinit() {
          ...
          $(this.defaults.carousel).each(function () {
            ...
            if ($this.parent().find(".carousel-arrows").length) {
              ...
              $this.closest(".holder").find(".carousel-arrows").length
            ) {
        ...
        THEME.productisotopeSM = {
          ...
          init: function init(options) {
            ...
            $(that.defaults.gallery).each(function () {
              var $gallery = $(this),
                $filtersList = $(
                  that.defaults.filtersList,
                  $gallery.closest(".holder")
                );
              ...
              $gallery.imagesLoaded(function () {
                $gallery.isotope({
                  ...
                  filter: function filter() {
                    var filterResult = that.defaults.currentFilter
                      ? $(this).is(that.defaults.currentFilter)
                      : true;
                    return filterResult;
                  },
                });
          ...
          _filters: function _filters(obj) {
            var activeStart = void 0,
              ...
              $filtersList = $(
                obj.defaults.filtersList,
                $gallery.closest(".holder")
              ),
              $filtersLabel = $(
                obj.defaults.filtersList + " " + obj.defaults.filtersLabel
              ),
            ...
            $filtersLabel.each(function () {
              ...
              var filtered = $this.attr(dataAttr),
                count =
                  filtered == null
                    ? $gallery.find(obj.defaults.galleryItem).length
                    : $gallery.find(filtered).length;
            ...
            if ($filtersList.length) {
              ...
              $gallery.imagesLoaded(function () {
                $gallery.isotope({
                  ...
                  percentPosition: true,
                  filter: function filter() {
                    var filterResult = obj.defaults.currentFilter
                      ? $(this).is(obj.defaults.currentFilter)
                      : true;
                    return filterResult;
                  },
                });
      ...
      if ($(el).length) {
        THEME.gallery = {
          ...
          _popup: function _popup(obj) {
            ...
            var $popupImage = $(
              obj.defaults.gallery + " " + obj.defaults.popupImage
            );
    ...
    carouselTab: function carouselTab() {
      THEME.carouseltab = {
        ...
        _handler: function _handler() {
          ...
          $(that.defaults.tab, $(that.defaults.carousel).closest(".holder")).on(
            "click",
            function (e) {
              var $this = $(this),
    ...
    instaFeed: function instaFeed(el) {
      $(el).each(function () {
        ...
        var userFeed = new Instafeed({
          ...
          template:
            '<a href={{link}} target="_blank" id={{id}}><span><img src={{image}} /></span></a>',
          links: false,
          limit: limit,
  ...
  THEME.documentReady = {
    init: function init() {
      ...
      if ($(".js-creative-product-carousel").length)
        THEME.sections.creativeSlider(".js-creative-product-carousel");
    },
  };
  THEME.documentLoad = {
    init: function init() {
    ...
    init: function init() {
      ...
      resizeTimer = setTimeout(function () {
        if ((window.innerWidth || $window.width()) == w) {
          ...
          THEME.mobilemenupush ? THEME.mobilemenupush.reinit() : false;
          THEME.flowtype
            ? THEME.flowtype.reinit(".bnr[data-fontratio]")
            : false;
          THEME.productpagegallery ? THEME.productpagegallery.reinit() : false;
          THEME.productpagegallery_qw
            ? THEME.productpagegallery_qw.reinit()
            : false;
          if ($(".js-post-prw-adaptive").length)
            THEME.sections.postWidth(".js-post-prw-adaptive");
