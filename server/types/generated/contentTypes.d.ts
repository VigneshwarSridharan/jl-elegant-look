...
export interface ApiCommonCommon extends Schema.SingleType {
  ...
  attributes: {
    ...
    PhoneNumbers: Attribute.Component<'common.single-text', true>;
    emailAddresses: Attribute.Component<'common.single-text', true>;
    address: Attribute.Text;
    socialMedia: Attribute.Component<'common.social-media', true>;
    seo: Attribute.Component<'common.seo'>;
...
export interface ApiEnquiryEnquiry extends Schema.CollectionType {
  ...
  attributes: {
    ...
    emailAddress: Attribute.String & Attribute.Required;
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    ...
    customerEmail: Attribute.String & Attribute.Required & Attribute.Private;
    customerMobileNumber: Attribute.String &
      Attribute.Required &
      Attribute.Private;
    cart: Attribute.Component<'products.cart', true> &
      Attribute.Required &
      Attribute.SetMinMax<
        {
          min: 1;
